    ...
    public static class Model
    {
        ...
        public static readonly LinguisticVariable[] InputLVs = new[]
        {
            new LinguisticVariable
            {
                ...
                Terms = new()
                {
                    [Terrible] = (double x) => MembershipFunctions.Sigmf(x, -11.9, 2.5),
                    [Bad] = (double x) => MembershipFunctions.Gauss2mf(x, 0.506, 3.105, 0.506, 4.42),
        ...
        public static readonly LinguisticVariable OutputLV = new()
        {
            ...
            Terms = new()
            {
                [Terrible] = (double x) => MembershipFunctions.Sigmf(x, -11.9, 1.49),
                [Bad] = (double x) => MembershipFunctions.Gauss2mf(x, 0.506, 2.1, 0.506, 4.011),
